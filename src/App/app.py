...
database_audio_folder = os.path.join('static', 'audio')
...
def index():
    ...
    if request.method == 'POST':
        ...
        input_audio_path = url_for('static', filename='uploads/' + audio_file.filename)
    
    return render_template('index.html', input_audio_path=input_audio_path, similar_audio_paths=similar_audio_paths)
